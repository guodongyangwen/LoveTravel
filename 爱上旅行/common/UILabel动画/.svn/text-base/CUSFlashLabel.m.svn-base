...
- (NSString *)setLabel:(NSString *)label
{
    UILabel * Lael = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, self.bounds.size.width, 44)];
    Lael.backgroundColor = [UIColor yellowColor];
    Lael.text = label;
    
    Lael.textColor = [UIColor yellowColor];
    
    NSString * string = Lael.text;

    NSString * st = [NSString stringWithFormat:@"卧槽 %@",string];
