...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if([[[UIDevice currentDevice] systemVersion] floatValue]>=8.0){
        //注册推送通知
        UIUserNotificationType types=UIUserNotificationTypeAlert|UIRemoteNotificationTypeSound|UIUserNotificationTypeBadge;
        //categories 是Action的集合
...
//    [[UIApplication sharedApplication] registerForRemoteNotificationTypes:UIRemoteNotificationTypeBadge|UIRemoteNotificationTypeSound|UIRemoteNotificationTypeAlert];
   ...
   //网络监测
    ...
    //设置夜间模式
    //创建一个  蒙版
    self.viewDark = [[UIView alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
    _viewDark.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.35];
    _viewDark.userInteractionEnabled = NO;
    _viewDark.tag = 555;
    [[UIApplication sharedApplication].keyWindow addSubview:_viewDark];
    [_viewDark setHidden:YES];
...
{
    NSLog(@"My token is :%@",[[NSString alloc]initWithData:deviceToken encoding:NSUTF8StringEncoding]);
    NSLog(@"%@",deviceToken);
}
//ec78c35a0c57d10884756e970fca6c5cf49d89fba8cd3eb6bf84cff297c9a335
